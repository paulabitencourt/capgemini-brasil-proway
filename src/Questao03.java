...
public class Questao03 {
    public static void main(String[] args) {
        ...
        //copia da palavraAnagrama para realização da comparação da string consigo mesma
        ...
        /*Infelizmente essa etapa não foi concluida, mas seria responsável por montar
         não consegui. O objetivo inicial era realizar e descobrir todas as substrings com
        esse looping, como também realizar a reversão dela para conseguir fazer a comparação
